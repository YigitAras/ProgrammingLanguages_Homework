...
%}
// Tokens below
%token tOPEN tCLOSE tSELF tEND tCOURSE tMEETING tITEM tCODE tSECTION tSTART tDAY tTYPE tCONSTRAINT tNAME
%token tINSTRUCTOR tCRN tEND_A tCAPACITY tCLASS tMON tTUE tTHU tWED tFRI tTIME tSTRING tNUM

%% /* Grammer Rules Below and Actions aswell */
